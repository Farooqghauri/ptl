  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm h-full overflow-auto flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-[#0A2342]">💬 Client Chatbot</h2>
      ...
      <p className="text-sm text-gray-600 mb-4">
        Ask me any legal question. I&apos;m here to help with Pakistani law and legal matters.
      </p>
      ...
      <div className="flex-1 mb-4 border rounded-lg p-4 h-96 overflow-y-auto bg-gray-50">
        {messages.length === 0 ? (
          <div className="text-center text-gray-500 mt-8">
            ...
            <p className="text-sm mt-2">Try: &quot;What are the requirements for filing a divorce?&quot;</p>
          </div>
        ) : (
