...
export default function AILegalDrafting() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm h-full overflow-auto flex flex-col border border-gray-200">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Ask me to draft any legal document. I&apos;ll help you create
        professional and legally sound drafts.
      </p>
      ...
      <div className="flex-1 mb-4 border rounded-lg p-4 h-96 overflow-y-auto bg-gray-50">
        {messages.length === 0 ? (
          <div className="text-center text-gray-500 mt-8">
            <p>Ask me to draft a legal document!</p>
            <p className="text-sm mt-2">
              Try: &quot;Draft a tenancy agreement between Summya and Farooq&quot;
            </p>
          </div>
        ) : (
      ...
      <form onSubmit={handleSendMessage} className="flex gap-2">
        <input
          ...
          placeholder="Ask me to draft a legal document..."
